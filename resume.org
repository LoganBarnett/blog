...
1. [[https://github.com/loganbarnett/blog/tree/gh-pages/resume.org][This résumé]] - Uses =org-mode= document and =jekyll= to generate an HTML
   based résumé.
2. [[https://github.com/LoganBarnett/dotfiles][My own dotfiles]] - If we value infrastructure as code, why not for our local
   machines? Also contains my Emacs configuration.
3. A few literate programs: [[https://github.com/LoganBarnett/40k-dps][40k-dps]], [[https://github.com/LoganBarnett/airbrush-dias][airbrush-dias]], [[https://github.com/LoganBarnett/typedef-gen][typedef-gen]].
4. [[https://github.com/LoganBarnett/flow-degen][flow-degen]] - Generate typesafe validation/deserialization JavaScript code.
5. [[https://github.com/LoganBarnett/cubed.js][cubed.js]] - A library to help me work on my voxel game.
6. [[https://github.com/LoganBarnett/runner][runner]] - My attempt at making a Rust command line replacement of
   Alfred/Quicksilver.
7. [[https://github.com/LoganBarnett/jj][jj]] - Run Jenkins jobs from the command line and see the output. Rust.
8. roid-miner - A generated asteroid mining game with a powerful editor for
   composing asteroid generators in real time.
9. meta-game - And editor using React + Redux + Three used for creating games
10. Various Unity games - Writing desktop/mobile games using Mono + C# and Boo
    (.net 3.5).
11. Monkeybars - MVC desktop GUI framework using JRuby and Swing.
12. Jemini - 2D game framework for JRuby.
13. Rawr - A packaging system creating double clickable app bundles for JRuby.
