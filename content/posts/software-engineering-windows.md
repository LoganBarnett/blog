...
aliases = ["/software-engineering-windows.html"]
draft = false
+++

<div class="ox-hugo-toc toc local">

- [Disclaimers, Audience, etc](#disclaimers-audience-etc)
    - [Objectiveness](#objectiveness)
    - [Articulation has Value](#articulation-has-value)
    - [You do You](#you-do-you)
    - [Actually Using Windows](#actually-using-windows)
- [A History with Microsoft](#a-history-with-microsoft)
- [Technical Considerations](#technical-considerations)
    - [The Model of Unix](#the-model-of-unix)
    - [Hostility towards Software Development](#hostility-towards-software-development)
- [Career Considerations](#career-considerations)
    - [How Others View Your Career](#how-others-view-your-career)
    - [How You Treat Your Own Career](#how-you-treat-your-own-career)
- [The Positive Encouragement Away](#the-positive-encouragement-away)
...
~~I <span class="underline">do</span> use Windows, begrudgingly, because one of my vices is playing video
...
Interesting things, yeah? So here's where <span class="underline">they hurt me</span>, or at least
...
the software industry to make that software keep going for [half a century or
more](https://en.wikipedia.org/wiki/Unix#History).  One such model in this ecosystem which will be covered is how
[everything is a file](https://en.wikipedia.org/wiki/Everything_is_a_file).  Let's dive into this for a moment.
...
PHP because of the [systemically broken nature of it](https://eev.ee/blog/2012/04/09/php-a-fractal-of-bad-design/), I steer away those same
engineers from working at Windows based workplaces.  The [Technical Considerations](#technical-considerations) builds why I think Windows is individually a bad choice.
...
process.  But I must use <span class="underline">something</span>.
...
Category Theory? New, shiny languages? [Fad server hosting](https://aws.amazon.com/)? Or even just go
