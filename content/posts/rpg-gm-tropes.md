...
#### using your screen to lie {#using-your-screen-to-lie}
...
game), or use some other narrative <span class="underline">outside of dice and combat</span>. And
...
#### story preparation {#story-preparation}
...
#### tell instead of show {#tell-instead-of-show}
...
a two handed sword <span class="underline">really isn't that different</span>, but taking great weapon
...
possible double or even triple-tap <span class="underline">fireballs</span> before <span class="underline">initiative is even
rolled</span>. And this happened. And the fucking sorcerer soloed an entire
...
a <span class="underline">giant ecosystem of other rules</span>. And before you say it's not that big,
<span class="underline">consider every spell is a rule</span>.
...
Even then, make sure your motivations aren't for [realism](#realism). Your game's rules
should outline a way that everyone can have fun that's consistent. Before
you bring down that house rule, consider: Is it <span class="underline">really that bad to leave as
it was</span>?
...
<span class="underline">Dextrous</span> doesn't necessarily mean <span class="underline">fast</span>. <span class="underline">Mobile</span> doesn't necessarily
mean <span class="underline">coordinated</span>. Hit points aren't necessarily meat points (they could be
...
Be a <span class="underline">slave</span> to the dice. They set you free. No player can blame you for
...
#### let the players drive the story {#let-the-players-drive-the-story}
...
#### your plot is their backgrounds {#your-plot-is-their-backgrounds}


#### embrace the heroism of the player characters {#embrace-the-heroism-of-the-player-characters}


#### make your monsters mean {#make-your-monsters-mean}


#### steer clear of house rules {#steer-clear-of-house-rules}


#### make a party together {#make-a-party-together}
