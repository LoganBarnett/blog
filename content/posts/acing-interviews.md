...
## Who Puts Together Interviews {#who-puts-together-interviews}
...
### Team Leads are Perpetually Behind {#team-leads-are-perpetually-behind}
...
### Team Leads Want Thinkers {#team-leads-want-thinkers}
...
### Team Leads are Tired of Cleaning up Messes {#team-leads-are-tired-of-cleaning-up-messes}
...
## The Goals of Interview Challenges {#the-goals-of-interview-challenges}
...
### Does the Résumé Match {#does-the-résumé-match}
...
much, but I'd hope senior level interviewees could tell me <span class="underline">something</span> about it.
If you're making database skins at the senior level, you should have a decent
idea of how to handle money safely.  The one interviewee I had that <span class="underline">didn't</span> use
floating point numbers got asked why he didn't use them - ha! There's no escape,
you see.


### How Does the Interviewee Solve Problems {#how-does-the-interviewee-solve-problems}
...
ones I know on such a public place. The whole point is to <span class="underline">make you struggle</span>.
...
The "how" of this process is far more important than the fact that <span class="underline">you actually
got it done</span>.  Sure, completing the challenge is a data point, but it's one
...
### Huge Bonus Points for Quality Work {#huge-bonus-points-for-quality-work}
...
## Interviewing is Messy and Highly Inaccurate {#interviewing-is-messy-and-highly-inaccurate}
...
### Queries for Tool Knowledge {#queries-for-tool-knowledge}
...
### Trying to Find a Clone {#trying-to-find-a-clone}


### Assuming Significant Interview Time {#assuming-significant-interview-time}


## How to Present Your Best {#how-to-present-your-best}
...
### Talk Through What You're Doing During Challenges {#talk-through-what-you-re-doing-during-challenges}
...
established that you're doing an old style because <span class="underline">you literally just said
that</span>.  I have the information I need regarding your current-ness.
...
### Be Painfully Blunt About What You Don't Know {#be-painfully-blunt-about-what-you-don-t-know}
...
### Ask the Interviewer What They Want to See {#ask-the-interviewer-what-they-want-to-see}
...
### Interview Them Back {#interview-them-back}
...
members - that's <span class="underline">work for me</span>.  Additionally it communicates that if you can't
...
<span class="underline">not</span> joke about the initialism for Bitbucket Cloud.


## For Entry Level Engineers {#for-entry-level-engineers}
...
5.  Be able to write a program that works on the command line.  I've seen a lot
    ...
    in terror.  There's a <span class="underline">really</span> good chance that an interview won't use
    ...
    programs.  I do have a sort of primer on [command line programs]({{< relref "command-line-programs" >}}) you're free to
    check out - though it covers way more than what I'm talking about here.  I'm
    talking about the simplest of programs here.


## "Aced" it, but Didn't Get the Job {#aced-it-but-didn-t-get-the-job}

You might do everything well in an interview and still not get the job. It might
have even gone swimmingly.


### The Interviewer Might Have Been Vetoed {#the-interviewer-might-have-been-vetoed}
...
### There Might Have Been a Better Candidate {#there-might-have-been-a-better-candidate}
