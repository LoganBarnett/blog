...
aliases = ["/javascript-promise-and-map.html"]
...
## the type signature of map {#the-type-signature-of-map}
...
## expressing map functionally {#expressing-map-functionally}

We could write our list's map function like this:

<a id="code-snippet--map-list"></a>
```js
...
there is <span class="underline">nothing</span> to do. Get it?
...
## bonus bonus: either {#bonus-bonus-either}
