...
date = 2018-07-10T00:00:00-07:00
aliases = ["/software-engineering-starter-web-03.html"]
categories = ["software-engineering"]
draft = false
+++

This is the third installment of this [Starter Web App]({{< relref "software-engineering-starter-web" >}}) series I'm doing. In
[part 2]({{< relref "software-engineering-starter-web-02" >}}) we made our app server respond with different formats based on headers
...
Whoa, it's like the <span class="underline">exact</span> same set of strings we passed to `res.send`! Spooky.


## making the data easy to change {#making-the-data-easy-to-change}
...
Wow, this looks like the <span class="underline">exact</span> same thing our `curl` output has, except
...
details from the [documentation on readFile here](https://nodejs.org/api/fs.html#fs_fs_readfile_path_options_callback) if you like, but we can go
...
The next part is [learning about git]({{< relref "software-engineering-starter-web-04" >}}) so you can have both a backup, a log of
