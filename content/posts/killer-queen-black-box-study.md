...
aliases = ["/killer-queen-black-box-study.html"]
...
- [things](#things)
    ...
    - [frame rate](#frame-rate)
        ...
        - [enter vsync](#enter-vsync)
        - [does KQ use vsync?](#does-kq-use-vsync)
        - [<span class="org-todo todo TODO">TODO</span> show example of vsync](#show-example-of-vsync)
    - [pixels](#pixels)
        - [2D as 3D](#2d-as-3d)
        - [what about the pixel graphics?](#what-about-the-pixel-graphics)
        - [<span class="org-todo todo TODO">TODO</span> conclusion](#conclusion)
    - [<span class="org-todo todo TODO">TODO</span> the wrap glitch](#the-wrap-glitch)
    - [game stutter](#game-stutter)
    - [<span class="org-todo todo TODO">TODO</span> the "drip"](#the-drip)
    - [collision](#collision)
...
<span class="timestamp-wrapper"><span class="timestamp">&lt;2018-06-05 Tue&gt;</span></span>
: add section about [character controllers](#characters).

<span class="timestamp-wrapper"><span class="timestamp">&lt;2018-03-22 Thu&gt;</span></span>
: add section about [game stutter](#game-stutter).

<span class="timestamp-wrapper"><span class="timestamp">&lt;2018-01-21 Sun&gt;</span></span>
: add section about [frame rate and vsync](#frame-rate).
...
<a id="code-snippet--time-delta-monitor"></a>
```javascript
