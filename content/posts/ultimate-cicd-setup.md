...
aliases = ["/ultimate-cicd-setup.html"]
...
## <span class="section-num">2</span> The Ultimate CI/CD Setup {#the-ultimate-ci-cd-setup}

<div class="ox-hugo-toc toc has-section-numbers local">

- <span class="section-num">2.1</span> [general philosophy](#general-philosophy)
    - <span class="section-num">2.1.1</span> [small releases](#small-releases)
    - <span class="section-num">2.1.2</span> [feature flags](#feature-flags)
- <span class="section-num">2.2</span> [automation](#automation)
    - <span class="section-num">2.2.1</span> [tests](#tests)
    - <span class="section-num">2.2.2</span> [deployment](#deployment)
    - <span class="section-num">2.2.3</span> [release notes](#release-notes)
        - <span class="section-num">2.2.3.1</span> [branch naming](#branch-naming)
        - <span class="section-num">2.2.3.2</span> [commit messages](#commit-messages)
        - <span class="section-num">2.2.3.3</span> [pull requests](#pull-requests)
        - <span class="section-num">2.2.3.4</span> [stringing together the whole process](#stringing-together-the-whole-process)
            - <span class="section-num">2.2.3.4.1</span> [<span class="org-todo todo TODO">TODO</span> add code to do the release note gathering](#add-code-to-do-the-release-note-gathering)
- <span class="section-num">2.3</span> [more to come](#more-to-come)
...
love pointing at [I Prefer This Over That](http://testobsessed.com/2015/05/i-prefer-this-over-that/) for reading material on the topic.
...
generally do a big release, and then hold a [war room](https://project-management-knowledge.com/definitions/w/war-room/) to catch the fallout. When
...
local
: This is your local environment, or what you do to iterate quickly on
...
develop
: (Or `dev`) is an environment with a singular purpose: It
...
integration
: This like `develop` except it interfaces with real external
...
staging
: This is QA's test bed. It should be gated. The reason being is that
...
production
: AKA `prod`. This is where our end users consume our software.
...
###### <span class="org-todo todo TODO">TODO</span> <span class="section-num">2.2.3.4.1</span> add code to do the release note gathering {#add-code-to-do-the-release-note-gathering}
