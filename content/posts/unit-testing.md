...
date = 2017-05-17T00:00:00-07:00
aliases = ["/unit-testing.html"]
categories = ["testing"]
draft = false
+++
...
- [How to Make Unit Testing not so much of a pain](#how-to-make-unit-testing-not-so-much-of-a-pain)
    - [Unit Testing](#unit-testing)
    - [Primer](#primer)
    - [Dress for Success](#dress-for-success)
        - [Do not DRY your tests](#do-not-dry-your-tests)
        - [Test Driven Development](#test-driven-development)
        - [Keep your tests](#keep-your-tests)
        - [Assert a single truth per test](#assert-a-single-truth-per-test)
        - [Clearly state your intent](#clearly-state-your-intent)
        - [Avoid blob tests](#avoid-blob-tests)
        - [Use acceptance tests instead](#use-acceptance-tests-instead)
        - [Or use an algebraic type system instead](#or-use-an-algebraic-type-system-instead)
...
#### Do not [DRY](https://en.wikipedia.org/wiki/Don't_repeat_yourself) your tests {#do-not-dry-your-tests}
...
unit tests to be [WET](https://en.wikipedia.org/wiki/Don't_repeat_yourself#DRY_vs_WET_solutions)!
...
provided, and you get a big [blob](https://en.wikipedia.org/wiki/Binary_large_object) of JSON or something similar. The test then
