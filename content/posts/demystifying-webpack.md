...
aliases = ["/demystifying-webpack.html"]
categories = ["javascript"]
draft = false
+++

## Demystifying Webpack {#demystifying-webpack}
...
[Webpack](https://webpack.js.org) is my go to. I like it because it adds static analysis to my file paths
...
fairness, Grunt really isn't a build tool - [just look at their site](https://gruntjs.com). It's a task
...
as obeying some convention and because we did, things Just Work(tm). See [Rails](http://rubyonrails.org).
...
[webpack-skeleton](https://github.com/LoganBarnett/webpack-skeleton)
