...
aliases = ["/functional-programming-with-angular.html"]
draft = false
+++
...
- [Functional Programming with Angular](#functional-programming-with-angular)
    - [Angular and Functional programming](#angular-and-functional-programming)
    - [Checklist to get functional](#checklist-to-get-functional)
        - [Get on a package manager](#get-on-a-package-manager)
        - [Export all the things](#export-all-the-things)
        - [Demolish privacy](#demolish-privacy)
        - [Pass more parameters](#pass-more-parameters)
        - [Pass functions, not objects](#pass-functions-not-objects)
        - [Mutate state at the last possible second](#mutate-state-at-the-last-possible-second)
    - [Added benefit: Unit testing](#added-benefit-unit-testing)
...
It's no secret I've been happily learning, applying, and [shouting out about
functional programming](https://soundcloud.com/lambda-cast). Prior blog posts, a functional programming podcast that
...
heavily applying [DRY](https://en.wikipedia.org/wiki/Don't_repeat_yourself) to the tests. Now the tests are small applications of
...
a promise. Can you mock that? Can you give it something that <span class="underline">didn't</span>
...
structure and mark it as changed <span class="underline">even if it's the same data</span>. You'll see
