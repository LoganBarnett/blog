...
aliases = ["/control-flow-simplified-01.html"]
draft = false
+++
...
## Motivation for Control Flow {#motivation-for-control-flow}
...
## Why Imperative Control Flow is Inherently Flawed {#why-imperative-control-flow-is-inherently-flawed}
...
don't define what happens as much as <span class="underline">how</span> it happens. It's an exercise for the
...
This example borrows heavily from [Scott Wlaschin's talk on Railway Oriented
Programming](https://vimeo.com/113707214). It's worth the hour-long watch, but not required for this tutorial.
...
### Control Flow Ruination {#control-flow-ruination}
...
### Dropping Control Flow For Sanity {#dropping-control-flow-for-sanity}
