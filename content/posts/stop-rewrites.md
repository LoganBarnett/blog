...
## <span class="section-num">2</span> Technical Debt {#technical-debt}
...
## <span class="section-num">3</span> Legacy {#legacy}
...
## <span class="section-num">4</span> The Model {#the-model}
...
### <span class="section-num">4.1</span> Maintaining Documentation {#maintaining-documentation}
...
### <span class="section-num">4.2</span> Perspective on What's to Come {#perspective-on-what-s-to-come}
...
### <span class="section-num">4.3</span> Edge Cases {#edge-cases}
...
riddled with edge cases. ["I before E except after C"](https://www.econtentpro.com/blog/i-before-e-except-after-c-exceptions/18) is a really common one, but
...
## <span class="section-num">5</span> Other Costs of Rewriting {#other-costs-of-rewriting}
...
## <span class="section-num">6</span> So What, I'm stuck with X while the world moves onto Y? {#so-what-i-m-stuck-with-x-while-the-world-moves-onto-y}
...
with the opinions of Martin Fowler, but his article on [StrangleFigApplication](https://martinfowler.com/bliki/StranglerFigApplication.html) is
...
deferring <span class="underline">all</span> of its calls to the legacy system. Sure it has overhead, but I
...
## <span class="section-num">7</span> But you said I'll still have technical debt {#but-you-said-i-ll-still-have-technical-debt}
...
## <span class="section-num">8</span> Legacy Ain't All That Bad {#legacy-ain-t-all-that-bad}
