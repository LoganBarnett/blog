...
#+hugo_base_dir: ..
#+hugo_section: posts
#+hugo_categories: open-source monitoring projects

* Introduction

I built a tool I call [[https://github.com/LoganBarnett/sonify-health][sonify-health]], which I use to assist with monitoring my
...
inference.  That's all from just hearing things _while I'm doing something
else_.  At some point I realize what I'm hearing is not what I _should be
hearing_.
