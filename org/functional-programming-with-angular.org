...
#+hugo_base_dir: ..
#+hugo_section: posts
#+hugo_aliases: /functional-programming-with-angular.html
...
** Added benefit: Unit testing
   ...
   testing is still fuzzy for you, check out my post on [[file:./unit-testing.org][How to Make Unit Testing
