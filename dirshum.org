...
# This doesn't hit the div, but just the image.  We still don't have consistent
# IDs.
#+attr_html: :id dirshum--map--figure
...
** magic items
:PROPERTIES:
:CUSTOM_ID: dirshum--magic-items
:END:

#+include: "../../notes/dm.org::#campaigns--era-of-eras--wand-of-woe--economy--magic-items" :only-contents t

** campaigns
:PROPERTIES:
:CUSTOM_ID: dirshum--campaigns
:END:
*** Wand of Woe
:PROPERTIES:
:CUSTOM_ID: dirshum--campaigns--wand-of-woe
:END:
**** recaps
:PROPERTIES:
:CUSTOM_ID: dirshum--campaigns--wand-of-woe--recaps
:END:

***** session 1
:PROPERTIES:
:CUSTOM_ID: dirshum--campaigns--wand-of-woe--recaps--session-1
:END:
#+include: "../../notes/dm.org::#campaigns--era-of-eras--wand-of-woe--sessions--session-1--public" :only-contents t
***** session 2
:PROPERTIES:
:CUSTOM_ID: dirshum--campaigns--wand-of-woe--recaps--session-2
:END:
#+include: "../../notes/dm.org::#campaigns--era-of-eras--wand-of-woe--sessions--session-2--public" :only-contents t
***** session 3
:PROPERTIES:
:CUSTOM_ID: dirshum--campaigns--wand-of-woe--recaps--session-3
:END:
#+include: "../../notes/dm.org::#campaigns--era-of-eras--wand-of-woe--sessions--session-3--public" :only-contents t
***** session 4
:PROPERTIES:
:CUSTOM_ID: dirshum--campaigns--wand-of-woe--recaps--session-4
:END:
#+include: "../../notes/dm.org::#campaigns--era-of-eras--wand-of-woe--sessions--session-4--public" :only-contents t
***** session 5
:PROPERTIES:
:CUSTOM_ID: dirshum--campaigns--wand-of-woe--recaps--session-5
:END:
#+include: "../../notes/dm.org::#campaigns--era-of-eras--wand-of-woe--sessions--session-5--public" :only-contents t
***** session 6
:PROPERTIES:
:CUSTOM_ID: dirshum--campaigns--wand-of-woe--recaps--session-6
:END:
#+include: "../../notes/dm.org::#campaigns--era-of-eras--wand-of-woe--sessions--session-6--public" :only-contents t
***** session 7
:PROPERTIES:
:CUSTOM_ID: dirshum--campaigns--wand-of-woe--recaps--session-7
:END:
#+include: "../../notes/dm.org::#campaigns--era-of-eras--wand-of-woe--sessions--session-7--public" :only-contents t
***** session 8
:PROPERTIES:
:CUSTOM_ID: dirshum--campaigns--wand-of-woe--recaps--session-8
:END:
#+include: "../../notes/dm.org::#campaigns--era-of-eras--wand-of-woe--sessions--session-8--public" :only-contents t
***** session 9
:PROPERTIES:
:CUSTOM_ID: dirshum--campaigns--wand-of-woe--recaps--session-9
:END:
#+include: "../../notes/dm.org::#campaigns--era-of-eras--wand-of-woe--sessions--session-9--public" :only-contents t
***** session 10
:PROPERTIES:
:CUSTOM_ID: dirshum--campaigns--wand-of-woe--recaps--session-10
:END:
#+include: "../../notes/dm.org::#campaigns--era-of-eras--wand-of-woe--sessions--session-10--public" :only-contents t
***** session 11
:PROPERTIES:
:CUSTOM_ID: dirshum--campaigns--wand-of-woe--recaps--session-11
:END:
#+include: "../../notes/dm.org::#campaigns--era-of-eras--wand-of-woe--sessions--session-11--public" :only-contents t
***** session 12
:PROPERTIES:
:CUSTOM_ID: dirshum--campaigns--wand-of-woe--recaps--session-12
:END:
#+include: "../../notes/dm.org::#campaigns--era-of-eras--wand-of-woe--sessions--session-12--public" :only-contents t
***** session 13
:PROPERTIES:
:CUSTOM_ID: dirshum--campaigns--wand-of-woe--recaps--session-13
:END:
#+include: "../../notes/dm.org::#campaigns--era-of-eras--wand-of-woe--sessions--session-13--public" :only-contents t
***** session 14
:PROPERTIES:
:CUSTOM_ID: dirshum--campaigns--wand-of-woe--recaps--session-14
:END:
#+include: "../../notes/dm.org::#campaigns--era-of-eras--wand-of-woe--sessions--session-14--public" :only-contents t
***** session 15
:PROPERTIES:
:CUSTOM_ID: dirshum--campaigns--wand-of-woe--recaps--session-15
:END:
#+include: "../../notes/dm.org::#campaigns--era-of-eras--wand-of-woe--sessions--session-15--public" :only-contents t
***** session 16
:PROPERTIES:
:CUSTOM_ID: dirshum--campaigns--wand-of-woe--recaps--session-16
:END:
#+include: "../../notes/dm.org::#campaigns--era-of-eras--wand-of-woe--sessions--session-16--public" :only-contents t
***** session 17
:PROPERTIES:
:CUSTOM_ID: dirshum--campaigns--wand-of-woe--recaps--session-17
:END:
#+include: "../../notes/dm.org::#campaigns--era-of-eras--wand-of-woe--sessions--session-17--public" :only-contents t
***** session 18
:PROPERTIES:
:CUSTOM_ID: dirshum--campaigns--wand-of-woe--recaps--session-18
:END:
#+include: "../../notes/dm.org::#campaigns--era-of-eras--wand-of-woe--sessions--session-18--public" :only-contents t
***** session 19
:PROPERTIES:
:CUSTOM_ID: dirshum--campaigns--wand-of-woe--recaps--session-19
:END:
#+include: "../../notes/dm.org::#campaigns--era-of-eras--wand-of-woe--sessions--session-19--public" :only-contents t
***** session 20
:PROPERTIES:
:CUSTOM_ID: dirshum--campaigns--wand-of-woe--recaps--session-20
:END:
#+include: "../../notes/dm.org::#campaigns--era-of-eras--wand-of-woe--sessions--session-20--public" :only-contents t
***** session 21
:PROPERTIES:
:CUSTOM_ID: dirshum--campaigns--wand-of-woe--recaps--session-21
:END:
#+include: "../../notes/dm.org::#campaigns--era-of-eras--wand-of-woe--sessions--session-21--public" :only-contents t
***** session 22
:PROPERTIES:
:CUSTOM_ID: dirshum--campaigns--wand-of-woe--recaps--session-22
:END:
#+include: "../../notes/dm.org::#campaigns--era-of-eras--wand-of-woe--sessions--session-22--public" :only-contents t
***** session 23
:PROPERTIES:
:CUSTOM_ID: dirshum--campaigns--wand-of-woe--recaps--session-23
:END:
#+include: "../../notes/dm.org::#campaigns--era-of-eras--wand-of-woe--sessions--session-23--public" :only-contents t
***** session 24
:PROPERTIES:
:CUSTOM_ID: dirshum--campaigns--wand-of-woe--recaps--session-24
:END:
#+include: "../../notes/dm.org::#campaigns--era-of-eras--wand-of-woe--sessions--session-24--public" :only-contents t
***** session 25
:PROPERTIES:
:CUSTOM_ID: dirshum--campaigns--wand-of-woe--recaps--session-25
:END:
#+include: "../../notes/dm.org::#campaigns--era-of-eras--wand-of-woe--sessions--session-25--public" :only-contents t
***** session 26
:PROPERTIES:
:CUSTOM_ID: dirshum--campaigns--wand-of-woe--recaps--session-26
:END:
#+include: "../../notes/dm.org::#campaigns--era-of-eras--wand-of-woe--sessions--session-26--public" :only-contents t
***** session 27
:PROPERTIES:
:CUSTOM_ID: dirshum--campaigns--wand-of-woe--recaps--session-27
:END:
#+include: "../../notes/dm.org::#campaigns--era-of-eras--wand-of-woe--sessions--session-27--public" :only-contents t
***** session 28
:PROPERTIES:
:CUSTOM_ID: dirshum--campaigns--wand-of-woe--recaps--session-28
:END:
#+include: "../../notes/dm.org::#campaigns--era-of-eras--wand-of-woe--sessions--session-28--public" :only-contents t
***** session 29
:PROPERTIES:
:CUSTOM_ID: dirshum--campaigns--wand-of-woe--recaps--session-29
:END:
#+include: "../../notes/dm.org::#campaigns--era-of-eras--wand-of-woe--sessions--session-29--public" :only-contents t
***** session 30
:PROPERTIES:
:CUSTOM_ID: dirshum--campaigns--wand-of-woe--recaps--session-30
:END:
#+include: "../../notes/dm.org::#campaigns--era-of-eras--wand-of-woe--sessions--session-30--public" :only-contents t

***** session 31
:PROPERTIES:
:CUSTOM_ID: dirshum--campaigns--wand-of-woe--recaps--session-31
:END:

#+include: "../../notes/dm.org::#campaigns--era-of-eras--wand-of-woe--sessions--session-31--public" :only-contents t

***** session 32
:PROPERTIES:
:CUSTOM_ID: dirshum--campaigns--wand-of-woe--recaps--session-32
:END:

#+include: "../../notes/dm.org::#campaigns--era-of-eras--wand-of-woe--sessions--session-32--public" :only-contents t

***** session 33
:PROPERTIES:
:CUSTOM_ID: dirshum--campaigns--wand-of-woe--recaps--session-33
:END:

#+include: "../../notes/dm.org::#campaigns--era-of-eras--wand-of-woe--sessions--session-33--public" :only-contents t
***** session 34
:PROPERTIES:
:CUSTOM_ID: dirshum--campaigns--wand-of-woe--recaps--session-34
:END:

#+include: "../../notes/dm.org::#campaigns--era-of-eras--wand-of-woe--sessions--session-34--public" :only-contents t

***** session 35
:PROPERTIES:
:CUSTOM_ID: dirshum--campaigns--wand-of-woe--recaps--session-35
:END:

#+include: "../../notes/dm.org::#campaigns--era-of-eras--wand-of-woe--sessions--session-35--public" :only-contents t

***** session 36
:PROPERTIES:
:CUSTOM_ID: dirshum--campaigns--wand-of-woe--recaps--session-36
:END:

#+include: "../../notes/dm.org::#campaigns--era-of-eras--wand-of-woe--sessions--session-36--public" :only-contents t
*** Jerry the Joblin
:PROPERTIES:
:CUSTOM_ID: dirshum--campaigns--jerry-the-joblin
:END:

See [[./jerry-the-joblin.org]].
